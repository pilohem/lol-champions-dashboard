...
def update_selected_champions_by_type(selected_type):
    ...
    ), href=f"/champion-{c}", style={"margin": "0.5rem", "width": "100%"}) for c in champions[sublist[0]:sublist[1]]]
    ...
    ), href=f"/champion-{c}", style={"margin": "0.5rem", "width": "100%"}) for c in champions[sublist[1]:sublist[2]]]
    list_items3 = [dbc.ListGroupItem(dbc.Card(
        ...
        ), href=f"/champion-{c}", style={"margin": "0.5rem", "width": "100%"}) for c in champions[sublist[2]:sublist[3]]
    ]
    ...
    list_items4 = [dbc.ListGroupItem(dbc.Card(
        ...
        ), href=f"/champion-{c}", style={"margin": "0.5rem", "width": "100%"}) for c in champions[sublist[3]:sublist[4]]
    ]
    ...
    list_items5 = [dbc.ListGroupItem(dbc.Card(
        ...
        ), href=f"/champion-{c}", style={"margin": "0.5rem", "width": "100%"}) for c in champions[sublist[4]:]
    ]
